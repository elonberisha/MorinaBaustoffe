...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof gsap !== 'undefined') {
        ...
        gsap.from('.visual-card', {
            opacity: 0, scale: 0.8, duration: 1, delay: 0.6
        });
        
        gsap.from('.float-icon', {
            opacity: 0, scale: 0, duration: 0.6, stagger: 0.15, delay: 1.5
        });
        ...
        // Cards animations - removed for services, products, features, and clients
    }
...
// =========================================
// SECTION NAVIGATION ARROWS - REMOVED
// =========================================
// Navigation arrows for mobile removed per user request
