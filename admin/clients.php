    ...
    <div class="grid">
      <div class="card">
        ...
        <form method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="client_description">Përshkrimi i shkurtër</label>
            <textarea id="client_description" name="client_description" placeholder="p.sh. Partner strategjik në furnizime"></textarea>
          </div>
          <div class="form-group">
            ...
            <?php foreach ($clients as $client): ?>
              <form method="post" enctype="multipart/form-data" class="client-row">
                ...
                <div class="client-details">
                  ...
                  <div class="form-group">
                    <label for="description_<?php echo htmlspecialchars($client['id']); ?>">Përshkrimi</label>
                    <textarea id="description_<?php echo htmlspecialchars($client['id']); ?>" name="client_description" placeholder="Përshkrim i partnerit"><?php echo htmlspecialchars($client['description'] ?? ''); ?></textarea>
                    <small>Ky tekst shfaqet poshtë logos në seksionin e partnerëve.</small>
                  </div>
                  <div class="actions">
